    ...
    async runBatch({ limit = 0, signal, isCancelled = () => false, onEvent = () => {} } = {}) {
      ...
      for (let index = 0; index < rows.length; index += 1) {
        ...
        try {
          ...
          ], { temperature: 0.1, timeoutMs: 45000, signal });
