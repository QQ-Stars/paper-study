    ...
    <div className={`page reproduction-page${listOnly ? ' reproduction-page--list' : ''}${detailOnly ? ' reproduction-page--detail' : ''}`}>
      <header className="reproduction__header">
        <div>
          ...
          <p>{detailOnly && selected ? `关联论文：${selected.paperTitle || '未关联论文'} · 记录实验、结果与复现笔记` : '记录实验、结果与复现笔记，让每次尝试都可追溯。'}</p>
        </div>
